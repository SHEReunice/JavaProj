...
public class ClientLogin extends JFrame
{
    ...
    private void Initialize()
    {
        ...
        Icon Back = new ImageIcon("E:\\java课设\\Java-master\\JavaProject\\InLook\\Images\\InLook.png");
    ...
    private void Login()
    {
        ...
        new ClientWebPage(Account_IN.getText(),new String(Password_IN.getPassword()));
    }
