...
public class ClientWebPage extends JFrame
{
    ...
    public ClientWebPage(String account, String password) throws HeadlessException
    {
        //super();
        Account = account;
        Password = password;
    ...
    private void Exit()
    {
        int inquire = JOptionPane.showConfirmDialog(ClientWebPage.this,
